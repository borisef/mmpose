...
work_dir = '/home/borisef/projects/mm/mmpose/tools/atraf/borisef/work_dirs/rtmposem_try'
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            ...
            checkpoint = '/home/borisef/models/mmpose/cspnext-m_udp-aic-coco_210e-256x192-f2f7d6f6_20230130.pth'
        )),
    head=dict(
        type='RTMCCHead',
        in_channels=768,
        out_channels=14, #NUM KEYPOINTS ?
...
data_mode = 'topdown'
data_root = '/home/borisef/projects/mm/mmpose/data/'
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_mode=data_mode,
        ann_file='crowdpose/annotations/mmpose_crowdpose_test.json',
        bbox_file=data_root + 'crowdpose/annotations/det_for_crowd_test_0.1_0.5.json',
        data_prefix=dict(img='crowdpose/images/'),
        test_mode=True,
