...
MY_BATCH = 12
work_dir =  '/home/borisef/projects/mm/mmpose/tools/atraf/borisef/work_dirs/coco_vit_small'
resume = True
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint = "/home/borisef/models/mmpose/mae_pretrain_vit_small_20230913.pth"
